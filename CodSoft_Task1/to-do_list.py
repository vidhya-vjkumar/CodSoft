...
root.wm_iconbitmap("To-Do List\\todo.ico")

img=ImageTk.PhotoImage((Image.open("To-Do List\\todo.jpg").resize((500,600))))
...
delete_icon=ImageTk.PhotoImage((Image.open("To-Do List\dlt.png").resize((20,20))))
